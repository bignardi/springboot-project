...
ALTER TABLE ONLY public.tb_product_category
    ADD CONSTRAINT tb_product_category_pkey PRIMARY KEY (product_id, categoty_id);
...
--
-- Name: tb_product_category fkc3copvros4rjjpxyqun0kq7ey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_product_category
    ADD CONSTRAINT fkc3copvros4rjjpxyqun0kq7ey FOREIGN KEY (categoty_id) REFERENCES public.tb_category(id);
